...
Thanks for your interest in contributing to `gateway` — Pilot Protocol gateway plugin — maps virtual pilot addresses to local loopback aliases for legacy TCP apps.

## Quick start

```bash
git clone https://github.com/pilot-protocol/gateway.git
cd gateway
go test -race ./...
```
